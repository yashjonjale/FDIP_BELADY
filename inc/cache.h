...
// INSTRUCTION TLB
#define ITLB_SET 16 ///Yash ITLB confifguration
#define ITLB_WAY 4
...
// L1 INSTRUCTION CACHE ///Yash L1I confifguration
#define L1I_SET 64
#define L1I_WAY 8
...
class CACHE : public MEMORY {
  public:
    ...
    uint64_t pf_requested,
             pf_issued,
             pf_useful,///this is what we need to target - usefulness is pf_useful/pf_issued
             pf_useless,
             pf_fill;
    ...
    void add_mshr(PACKET *packet),
         ...
         l1i_initialize_replacement(),// we need it for l1i///Yash added l1i_initialize_replacement
         ...
         l1i_update_replacement_state(uint32_t cpu, uint32_t set, uint32_t way, uint64_t full_addr, uint64_t ip, uint64_t victim_addr, uint32_t type, uint8_t hit),///Yash added l1i_update_replacement_state
    ...
    uint32_t get_set(uint64_t address),
             ...
             l1i_find_victim(uint32_t cpu, uint64_t instr_id, uint32_t set, const BLOCK *current_set, uint64_t ip, uint64_t full_addr, uint32_t type),///Yash added l1i_find_victim
